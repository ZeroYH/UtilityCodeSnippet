...
- (NSMutableDictionary *)currentIPAdressDetailInfo {
    ...
    for (i=0; i<MAXADDRS; ++i)
    {
        ...
        inforDic[@"Name"] = [NSString stringWithFormat:@"%s", if_names[i]];
        inforDic[@"MAC"] = [NSString stringWithFormat:@"%s", hw_addrs[i]];
        inforDic[@"IP"] = [NSString stringWithFormat:@"%s", ip_names[i]];
    }
    return inforDic;
}
